    ...
    <div className="min-h-screen bg-deep-forest relative flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="waves-form-parent" x="0" y="0" width="100" height="40" patternUnits="userSpaceOnUse">
              <path d="M0 20 Q 25 10 50 20 T 100 20" fill="none" stroke="white" strokeWidth="2" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#waves-form-parent)" />
        </svg>
      </div>
      ...
      >
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <button 
            type="button"
            onClick={() => router.push("/signup/paywall")}
