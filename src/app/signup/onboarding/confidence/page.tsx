...
const options = [
  ...
  { id: "strategy", label: "Test Taking Strategy", icon: Monitor },
];
        ...
        <div className="relative w-full h-48 mb-8 flex items-center justify-center">
          ...
          >
            ...
            <motion.div 
               ...
               className="absolute -top-4 -right-4 bg-mint p-3 rounded-2xl shadow-xl"
            >
               <Check className="w-6 h-6 text-deep-forest" />
            </motion.div>
          </motion.div>
        </div>
