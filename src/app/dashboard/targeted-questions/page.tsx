...
const CATEGORY_GROUPS: CategoryGroup[] = [
  { id: "math-algebra", label: "Algebra & Equations", section: "math", description: "Linear equations, systems of equations, and algebraic expressions", icon: "🔢", targetCount: 100 },
  { id: "math-exponents", label: "Exponents & Powers", section: "math", description: "Exponent rules, scientific notation, and powers", icon: "⚡", targetCount: 100 },
  { id: "math-inequalities", label: "Inequalities", section: "math", description: "Solving and graphing inequalities, absolute value inequalities", icon: "⚖️", targetCount: 100 },
  { id: "math-ratios", label: "Ratios, Proportions & Percents", section: "math", description: "Ratios, proportions, percent calculations, and percent change", icon: "📊", targetCount: 100 },
  { id: "math-arithmetic", label: "Arithmetic & Number Sense", section: "math", description: "Fractions, decimals, order of operations, and number properties", icon: "🧮", targetCount: 100 },
  { id: "math-geometry-shapes", label: "Geometry — Shapes & Angles", section: "math", description: "Angles, triangles, circles, area, perimeter, and composite shapes", icon: "📐", targetCount: 100 },
  { id: "math-geometry-3d", label: "Geometry — 3D & Volume", section: "math", description: "Volume, surface area, and cross-sections of 3D shapes", icon: "🧊", targetCount: 100 },
  { id: "math-coordinate", label: "Coordinate Geometry & Transformations", section: "math", description: "Coordinate plane, slope, midpoint, distance, and transformations", icon: "📍", targetCount: 100 },
  { id: "math-statistics", label: "Statistics & Data Analysis", section: "math", description: "Mean, median, mode, range, data interpretation, and graphs", icon: "📈", targetCount: 100 },
  { id: "math-probability", label: "Probability & Counting", section: "math", description: "Basic and compound probability, Venn diagrams, and counting", icon: "🎲", targetCount: 100 },
  { id: "math-patterns", label: "Patterns & Sequences", section: "math", description: "Number patterns, arithmetic and geometric sequences", icon: "🔄", targetCount: 100 },
  { id: "math-word-problems", label: "Word Problems", section: "math", description: "Rate/distance/time, work problems, age problems, and multi-step", icon: "📝", targetCount: 100 },
  { id: "ela-main-idea", label: "Main Idea & Summary", section: "ela", description: "Identifying main ideas, themes, and summarizing passages", icon: "💡", targetCount: 100 },
  { id: "ela-inference", label: "Inference & Evidence", section: "ela", description: "Drawing inferences and identifying supporting evidence", icon: "🔍", targetCount: 100 },
  { id: "ela-literary", label: "Literary Analysis", section: "ela", description: "Figurative language, tone, mood, and character analysis", icon: "📖", targetCount: 100 },
  { id: "ela-grammar", label: "Grammar & Sentence Structure", section: "ela", description: "Subject-verb agreement, fragments, run-ons, modifiers, and parallelism", icon: "✏️", targetCount: 100 },
  { id: "ela-punctuation", label: "Punctuation & Mechanics", section: "ela", description: "Commas, semicolons, colons, apostrophes, and dashes", icon: "🔤", targetCount: 100 },
  { id: "ela-style", label: "Style, Tone & Word Choice", section: "ela", description: "Conciseness, word choice, active/passive voice, and register", icon: "🎨", targetCount: 100 },
  { id: "ela-passage-revision", label: "Passage Organization & Revision", section: "ela", description: "Transitions, sentence placement, paragraph order, and revision", icon: "🔧", targetCount: 100 },
];
